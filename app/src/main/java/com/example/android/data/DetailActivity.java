...
public class DetailActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
       ...
       /* String itemId = getIntent().getExtras().getString(DataItemAdapter.ITEM_ID_KEY);
        ...
        if (item != null) {
            Toast.makeText(this, "Recieved item " + item.getItemName(),
                    Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(this, "Did not recieved any data", Toast.LENGTH_SHORT).show();
        }
        Toast.makeText(this, "Recieved item" + item.getItemName(), Toast.LENGTH_SHORT).show();
    }
}
